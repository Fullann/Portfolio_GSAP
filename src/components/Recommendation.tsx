...
import { recomendationData } from "../assets/lib/h";
...
const Recommendation: React.FC = () => {
    ...
    const recommendation =
        language === "FR" ? recomendationData.recomendation_FR : recomendationData.recomendation_EN;

    return (
        <React.Fragment>
            <section className="about-me relative mt-16">
                <div className="title-container flex flex-col gap-6 justify-center items-center p-32 w-1/2 max-lg:w-full max-lg:p-16 max-lg:items-start">
                    ...
                    >
                        <p className="text-[--black] mb-6">
                            ...
                            {language === "FR" ? recomendationData.title : recomendationData.title_EN}
                            <span className="text-orange">/&gt;</span>
                        </p>

                        <h2 className="text-[--black] text-center max-lg:text-left break-words">
                            {language === "FR"
                                ? recomendationData.description
                                : recomendationData.description_EN}
                        </h2>
                    </motion.div>
                </div>
                <div>
                            ...
                            >
                                <div className="flex gap-6 flex-row justify-start items-center max-lg:flex-col max-lg:justify-center max-lg:text-center ">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-400 text-2xl">{recomendation.subtitle}</p>
                                    </div>
                                </div>
